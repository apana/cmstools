...
def main(argv) :
    ...
    if output_filename == '' :
        output_filename = parameter_set.split('.cfg')[0] + '_resolved.cfg'

    process = cms.include(parameter_set)

    temp = process.dumpConfig()
